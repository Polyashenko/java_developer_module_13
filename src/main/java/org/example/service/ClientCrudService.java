...
public class ClientCrudService implements CrudService<Client> {
    private org.example.HibernateUtil HibernateUtil;
    private final SessionFactory sessionFactory = org.example.HibernateUtil.getInstance().getSessionFactory();
    ...
    public void update(Client client) {
        try (Session session = sessionFactory.openSession()) {
            ...
            transaction.commit();
            log.info("Client updated: " + client.getFirstName());
        } catch (Exception e) {
    ...
    public void delete(Client client) {
        try (Session session = sessionFactory.openSession()) {
            ...
            transaction.commit();
            log.info("Client deleted: " + client.getFirstName());
        } catch (Exception e) {
